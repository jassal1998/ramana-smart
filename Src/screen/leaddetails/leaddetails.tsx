...
const[id,setId] =useState<string>("")
 ...
 const [datePickerConfirmed, setDatePickerConfirmed] = useState<boolean>(false);
  ...
  return (
    ...
    >
      ...
      <View style={style.inputWrapper}>
        ...
        />
       {errorMessage ? (
        <Text style={{ color: 'red', textAlign:'left',top:35 }}>{errorMessage}</Text>
      ) : null}
        <TouchableOpacity style={{ bottom: 10 }}>
